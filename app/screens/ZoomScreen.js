...
import { PermissionsAndroid, Platform, SafeAreaView, Text, View, ScrollView, StyleSheet } from 'react-native';
    ...
    return (
        ...
        <SafeAreaView style={styles.main}>
            ...
            <View style={styles.btnContainer}>
                <Text onPress={join} style={[styles.button, styles.joinBtn]}>
                    Join
                </Text>
                <Text onPress={leave} style={[styles.button, styles.leaveBtn]}>
                    Leave
                </Text>
            </View>
            <ScrollView
